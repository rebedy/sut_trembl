...
def main_worker(args: argparse.Namespace):
    ...
    if gpu == 0:
        ...
        ## Make DIRs
        exp_name = f"sut_generalised_{TODAY}{NOW}_txt{args.max_seq_len}_h{args.n_heads}_l{args.n_layers}_dff{args.ffn_dim}_d{args.dim}_bz{args.batch_size}"
